 ...
 */
package org.jboss.as.jms.mdb.remote.ra;
...
@MessageDriven(name = "RemoteQueueMDBRA", activationConfig = {
    ...
    @ActivationConfigProperty(propertyName = "destination", propertyValue = "/org/mybank/myRaQueue"),
...
public class RemoteQueueMDB_RA implements MessageListener {
    ...
    private static final String mdbName = "remote-mdb-hornetq-ra";
