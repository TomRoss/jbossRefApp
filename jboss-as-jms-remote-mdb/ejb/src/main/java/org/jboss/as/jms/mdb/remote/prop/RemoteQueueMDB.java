 ...
 */
package org.jboss.as.jms.mdb.remote.prop;
...
@MessageDriven(name = "RemoteQueueMDBProp", activationConfig = {
    @ActivationConfigProperty(propertyName = "destinationType", propertyValue = "javax.jms.Queue"),
    @ActivationConfigProperty(propertyName = "destination", propertyValue = "/org/mybank/myPropQueue"),
    ...
    @ActivationConfigProperty(propertyName = "jndiParams", propertyValue = "java.naming.factory.initial=org.jboss.naming.remote.client.InitialContextFactory;java.naming.provider.url=remote://localhost:4447;java.naming.security.principal=quickuser;java.naming.security.credentials=quick123+"),
...
public class RemoteQueueMDB implements MessageListener {
    ...
    private final static Logger log = Logger.getLogger(RemoteQueueMDB.class.toString());
    private static AtomicInteger mdbCnt = new AtomicInteger(0);
    private static final String mdbName = "remote-mdb-activation-prop";
